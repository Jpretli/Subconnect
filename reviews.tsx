  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-slate-900 mb-4">Reviews & Ratings</h1>
          ...
          {showReviewForm && selectedJob && (
            <div className="max-w-2xl mx-auto">
              <ReviewForm
                ...
                subcontractorId={1} // Mock subcontractor ID
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center space-y-4">
                  ...
                  <p className="text-slate-600">Based on 24 reviews</p>
